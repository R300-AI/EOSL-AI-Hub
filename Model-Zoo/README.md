...
#### [:point_right:Deploy Your AI Models to Genio](https://github.com/R300-AI/MTK-genio-demo/blob/main)
#### [:point_right:Deploy Your AI Models to Ryzen](https://github.com/R300-AI/AMD-ryzen-demo/blob/main)
